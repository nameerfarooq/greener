      ...
      <div className="inner">
        ...
        <div className="item2">
          ...
          <div className="right">
            ...
            <div className="text-7">
              ...
              environmental, electrical, thermal, and mechanical stresses, these
              cables are used in commercial, industrial, and residential
        ...
        <div className="item">
          ...
          <div className="right">
            ...
            <div className="text-7">
              ...
              international standards, XLPE insulated power cables are suitable
              for medium voltage (MV) applications. Available with Copper (Cu)
              or Aluminum (Al) conductors and PVC sheathing, these cables
        ...
        <div className="item2">
          ...
          <div className="right">
            ...
            <div className="text-7">
              PVC insulated power cables designed for voltage ranges from 1kV to
              3.3kV, meeting BS-6360 and various international standards.
              Suitable for power networks and auxiliary control, these cables
              feature Copper (Cu) or Aluminum (Al) conductors and are available
              in armored or unarmored versions with PVC sheathing.
              <br />
              Perfect for power networks and auxiliary control systems requiring
              low-tension power transmission.
            </div>
          </div>
        </div>
        <div className="item">
          ...
          <div className="right">
            <div className="text-5">Overhead conductors, aluminum & copper</div>
            <div className="text-7">
              Aluminum (Al) conductors such as AAC, AAAC, and ACSR, manufactured
              according to British Standards and international standards. Hard
              Drawn Bare Copper (HDBC) Conductors comply with various standards.
              Widely used in aerial power transmission and distribution lines,
